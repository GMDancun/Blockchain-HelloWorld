import { Canister, query, update, text, bool, Record, Variant, Result, StableBTreeMap, nat64, Opt, Some, None, Vec, } from 'azle';
...
export default Canister({
    ...
    registerFarmer: update([text, text, text], Result(text, Error), (name, contactNumber, address) => {
        ...
        const farmer = { id: farmerId, name: name, contactNumber: contactNumber, address: address };
    ...
    registerTractor: update([text], Result(text, Error), (brand) => {
        ...
        const tractor = { id: tractorId, brand: brand, available: true };
